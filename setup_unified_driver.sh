...
cat << 'DRIVER_EOF' > "${ROOT_DIR}/src/linum/unified_driver.py"
#!/usr/bin/env python3
import sys
import argparse
...
chmod +x "${ROOT_DIR}/src/linum/unified_driver.py"
echo "      [✔] Unified multi-engine CLI driver deployed at src/linum/unified_driver.py."
