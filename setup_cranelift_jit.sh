...
ROOT_DIR="$(pwd)"
mkdir -p "${ROOT_DIR}/src/linum_fastjit/src"

# Cargo Manifest for Pure Rust Cranelift JIT
cat << 'CARGO_EOF' > "${ROOT_DIR}/src/linum_fastjit/Cargo.toml"
[package]
name = "linum_fastjit"
version = "0.1.0"
edition = "2021"
...
# Cranelift Core Engine Implementation
cat << 'RUST_EOF' > "${ROOT_DIR}/src/linum_fastjit/src/lib.rs"
...
echo "      [✔] Cranelift low-latency JIT crate configured."
