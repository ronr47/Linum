        ...
        for bb in blocks:
            ...
            for instr in bb.instructions:
                ...
                if cname in ("IrAssign", "Assign"):
                    ...
                    ty_str = reg_types.get(src_clean, self._get_type_str(dest_clean, var_types, reg_types))
                    ...
                    ty_str = reg_types.get(resolved_clean, self._get_type_str(src_var, var_types, reg_types))
                    reg_types[target_clean] = ty_str
...
echo "Running pytest over all test suites..."
$PY_BIN -m pytest -vv
