...
# 1. Extract the raw, cynical C source under its new adaptive moniker: SOPHIA
cat << 'C_SRC' > sophia.c
#include <sys/mman.h>
#include <stddef.h>
#include <stdint.h>
...
# 2. Compile and run under the new binary signature
echo "[Host] Forcing optimization flags to obscure structural instability..."
gcc -O3 -march=native -Wall -Wextra sophia.c -o sophia_node
