...
print_section("1. AST NODES FOR STRUCTS (src/linum/ast/nodes.py)")
ast_path = Path("src/linum/ast/nodes.py")
if ast_path.exists():
...
print_section("2. SEMANTIC TYPE DEFINITIONS (src/linum/semantic/types.py)")
types_path = Path("src/linum/semantic/types.py")
...
cfg_path = Path("src/linum/lowering/cfg.py")
if cfg_path.exists():
