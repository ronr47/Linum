...
print_section("1. SSA DEFINITIONS (src/linum/lowering/ssa.py)")
try:
    import linum.lowering.ssa as ssa_mod
...
print_section("2. CFG DEFINITIONS (src/linum/lowering/cfg.py)")
try:
...
print_section("3. CURRENT LLVM EMITTER (src/linum/lowering/llvm.py)")
