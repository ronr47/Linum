...
print_section("1. SEMANTIC TYPES & OWNERSHIP (src/semantic/types.py)")
types_file = Path("src/semantic/types.py")
...
print_section("2. AST NODES (src/ast/nodes.py)")
...
print_section("4. LLVM EMITTER RUNTIME CALLS (src/lowering/llvm.py)")
